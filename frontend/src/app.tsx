...
export function App() {
  ...
  const securedRoutes = [
    ...
    { path: '/purchases', permission: 'purchases.view_purchase', element: <PurchasesPage user={user!} /> },
    ...
    { path: '/products', permission: 'products.view_product', element: <ProductsPage user={user!} /> },
    { path: '/products/cartons', permission: 'products.view_cartonpricing', element: <CartonPricingPage user={user!} /> },
    { path: '/customers', permission: 'customers.view_customer', element: <CustomersPage user={user!} /> },
    { path: '/suppliers', permission: 'suppliers.view_supplier', element: <SuppliersPage user={user!} /> },
    { path: '/employees', permission: 'accounts.view_employee', element: <EmployeesPage user={user!} /> },
    { path: '/coupons', permission: 'coupons.view_coupon', element: <CouponsPage user={user!} /> },
    { path: '/organization/company', permission: 'organization.view_company', element: <CompanyPage user={user!} /> },
    { path: '/organization/sites', permission: 'organization.view_site', element: <SitesPage user={user!} /> },
    { path: '/organization/departments', permission: 'organization.view_department', element: <DepartmentsPage user={user!} /> },
    { path: '/inventory', permission: 'inventory.view_stockbalance', element: <InventoryPage user={user!} /> },
    ...
    { path: '/payments', permission: 'payments.view_paymenttransaction', element: <PaymentsPage user={user!} /> },
    ...
    { path: '/accounting/accounts', permission: 'accounting.view_account', element: <AccountsPage user={user!} /> },
    { path: '/accounting/journals', permission: 'accounting.view_journalentry', element: <JournalsPage user={user!} /> },
