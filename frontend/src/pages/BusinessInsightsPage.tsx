...
function MetricCard({ title, value, subtitle, icon, color = 'indigo' }: { title: string; value: string; subtitle: string; icon: React.ReactNode; color?: string }) {
