...
import { IconBook, IconBox, IconBuilding, IconChartBar, IconChevronDown, IconClock, IconDashboard, IconFileInvoice, IconLightbulb, IconMoon, IconPackage, IconPower, IconReceipt, IconSearch, IconShoppingCart, IconSun, IconTruck, IconUsers, IconWallet } from '@tabler/icons-react';
