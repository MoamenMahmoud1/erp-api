    ...
    <div className="app-bg">
      ...
      >
          ...
          <Group h="100%" px="lg" justify="space-between">
            ...
            <Group gap="sm">
              ...
              <Group gap="xs" visibleFrom="sm">
                <Avatar radius="xl" color="indigo">{(user.first_name || user.username).slice(0, 1).toUpperCase()}</Avatar>
                <div>
        ...
        <AppShell.Navbar p="md">
                    ...
                    {section.items.map((item) => {
                      ...
                      return (
                        <NavLink
                          ...
                          active={active}
                          label={item.label}
                          leftSection={<Text size="sm" fw={800} w={22} ta="center">{item.glyph}</Text>}
          ...
          <AppShell.Section>
            <Divider my="md" />
            <Button fullWidth variant="subtle" leftSection={<IconPower size={16} />} onClick={logout} color="gray">Sign out</Button>
          </AppShell.Section>
        </AppShell.Navbar>
