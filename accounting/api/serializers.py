...
class AccountSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Account
        fields = ("id", "code", "name", "account_type", "parent", "is_active", "normal_side", "created_at", "updated_at")
...
class JournalEntrySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = JournalEntry
        fields = (
            "id", "number", "entry_date", "description", "reference", "source_type", "source_id",
            "status", "created_by", "posted_by", "posted_at", "created_at", "updated_at", "lines",
        )
        read_only_fields = (
            "id", "number", "status", "created_by", "posted_by", "posted_at", "created_at", "updated_at",
