...
The current ERP domain is a sales, purchases, inventory, payments and core-accounting backend. P2 hardening now covers historical inventory valuation, report scaling, request telemetry, cache/dependency readiness, and database recovery tooling.
