ROLE_DEFINITIONS = (
    ...
    },
    {
        ...
        "scope": "branch",
        "requires_shift": False,
        "permission_sets": (("app", "invoices"), ("app", "purchases"), ("app", "inventory"), ("app", "payments"), ("permissions", ("products", "view_product"), ("customers", "view_customer"), ("suppliers", "view_supplier"), ("accounts", "view_employee"), ("accounts", "view_employeeshift"), ("accounts", "view_all_employee_shifts"), ("organization", "view_site"), ("organization", "view_department"), ("accounting", "view_financial_reports"))),
    },
    {
        "code": "shop-manager",
        "name": "Shop Manager",
