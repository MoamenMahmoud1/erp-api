...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Employee
        fields = ("id", "user", "user_details", "manager", "manager_details", "work_site", "work_site_name", "department", "department_name", "created_at", "updated_at")
        read_only_fields = ("created_at", "updated_at", "work_site_name", "department_name", "manager_details", "user_details")
